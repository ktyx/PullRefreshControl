...
@interface KTFlashingTextAnimation ()

@property (nonatomic, strong) CABasicAnimation *currentAnimation;

@end

@implementation KTFlashingTextAnimation
...
- (void)start {
    ...
    [gradientMask addAnimation:_currentAnimation forKey:@"KTFlashingTextAnimation"];
}

- (void)stop {
    if(self.animatedView && self.animatedView.layer.mask){
        [self.animatedView.layer.mask removeAnimationForKey:@"KTFlashingTextAnimation"];
